...
DROP TABLE IF EXISTS `staffdriver`;
...
LOCK TABLES `staffdriver` WRITE;
/*!40000 ALTER TABLE `staffdriver` DISABLE KEYS */;
INSERT INTO `staffdriver` VALUES ('16mcmc50','123456');
/*!40000 ALTER TABLE `staffdriver` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-11-05 20:25:17
